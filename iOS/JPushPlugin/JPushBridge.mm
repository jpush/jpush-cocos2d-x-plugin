...
+ (APCallBackController *)sharedService {
  static dispatch_once_t onceJPUSHService;
  dispatch_once(&onceJPUSHService, ^{
 ...
 */
void JPushBridge::registerCallbackFunction(
 ...
 */
void JPushBridge::registerSetupCallbackFunction(
    void *p_handle, APNetworkDidSetup_callback setup_callback) {
  callbackController.setupCallback = setup_callback;
  setupHandle = p_handle;
};
 ...
 */
void JPushBridge::registerCloseCallbackFunction(
 ...
 */
void JPushBridge::registerRegisterCallbackFunction(
 ...
 */
void JPushBridge::registerLoginCallbackFunction(
 ...
 */
void JPushBridge::registerReceiveMessageCallbackFunction(
 ...
 */
void JPushBridge::setAliasAndTags(void *p_handle, const char *alias,
                                   set<string> *tags,
...
void JPushBridge::setTags(void *p_handle, set<string> *tags,
                           APTagAliasCallback callback) {
  if (callbackController) {
    setAliasTagsHandle = p_handle;
...
void JPushBridge::setAlias(void *p_handle, const char *alias,
                            APTagAliasCallback callback) {
  if (callbackController) {
    setAliasTagsHandle = p_handle;
 ...
 *
 */
bool JPushBridge::filterValidTags(c_tags tags, set<string> *result) {
  if (result == NULL) {
  ...
  NSSet *vaildSet = [JPUSHService filterValidTags:convert_to_oc(tags)];
  c_tags ctags = new set<string>;
 ...
 *
 */
void JPushBridge::pageStart(const char *pageName) {
  [JPUSHService startLogPageView:[NSString stringWithUTF8String:pageName]];
}

void JPushBridge::pageEnd(const char *pageName) {
  [JPUSHService stopLogPageView:[NSString stringWithUTF8String:pageName]];
}

void JPushBridge::pageDefine(const char *pageName, int duration) {
  [JPUSHService beginLogPageView:[NSString stringWithUTF8String:pageName]
                     duration:duration];
}
...
const char *JPushBridge::registrationID() {
  return [[JPUSHService registrionID] UTF8String];
}
void JPushBridge::setDebugMode(){
    [JPUSHService setDebugMode];
}
void JPushBridge::setLogOFF(){
