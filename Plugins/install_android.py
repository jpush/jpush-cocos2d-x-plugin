...
def copyCodeToProject():
    ...
    hfileTarget = context["dst_project_path"]+context["dst_project_name"]+"/Classes/JPushBridge.h"
    ...
    cppfileTarget = context["dst_project_path"]+context["dst_project_name"]+"/proj.android/jni/JPushBridge.cpp"
...
def replacePackageName():
    pushserverTarget = context["dst_project_path"]+context["dst_project_name"]+"/proj.android/jni/JPushBridge.cpp"
